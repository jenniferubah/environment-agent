...
func (s *KubevirtHandler) kubevirtVMToServerVM(vm *kubevirtv1.VirtualMachine) (*server.VM, error) {
	...
	serverVM, err := vmSpecToServerVM(vmSpec, path)
	if err != nil {
...
func (s *KubevirtHandler) GetHealth(ctx context.Context, _ server.GetHealthRequestObject) (server.GetHealthResponseObject, error) {
	status := "healthy"
...
func (s *KubevirtHandler) ListVMs(ctx context.Context, _ server.ListVMsRequestObject) (server.ListVMsResponseObject, error) {
...
func (s *KubevirtHandler) CreateVM(ctx context.Context, request server.CreateVMRequestObject) (server.CreateVMResponseObject, error) {
	...
	serverVM, err := vmSpecToServerVM(createdVMSpec, &path)
	if err != nil {
...
// DeleteVM handles DELETE /vms/{vmId}.
